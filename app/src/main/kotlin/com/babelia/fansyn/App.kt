...
import com.babelia.fansyn.audiostation.SynologyAudioStationModule
import com.babelia.fansyn.audiostation.ui.AlbumBasicData
import com.babelia.fansyn.audiostation.ui.AudioStationAlbumSongsViewModel
import com.babelia.fansyn.audiostation.ui.AudioStationAlbumsViewModel
import com.babelia.fansyn.crashreporting.PriorityUncaughtExceptionHandler
import com.babelia.fansyn.crashreporting.toPriorityUncaughtExceptionHandler
...
open class App : Application(), DIAware {
    ...
    override fun onCreate() {
        ...
        if (com.babelia.fansyn.BuildConfig.DEBUG) {
...
//        initializeExceptionHandling()
    ...
    private fun initializeInjection(initializeStores: Boolean) {
        ...
        di.addImports(
            ...
            // Domain
            AppModule.create(),
            SynologyAudioStationModule.create(),
            // UI
...
object ViewModelsModule {
    ...
    fun create() = DI.Module("HomeViewModelsModule", true) {
        bindViewModel { AudioStationAlbumsViewModel(instance(App.KODEIN_APP_TAG)) }
        bindViewModelFactory<AudioStationAlbumSongsViewModel, ViewModelProvider.Factory> { albumData ->
            TypedViewModelFactory(
                AudioStationAlbumSongsViewModel::class,
                instance(App.KODEIN_APP_TAG),
                albumData as AlbumBasicData
            )
        }
    }
}
